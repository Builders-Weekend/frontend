...
export default function JobQueue({ devices, prices }: IJobQueue) {
  ...
  const handleAddJobToQueue = () => {
    ...
    const halfHourIncrements = findHalfHourIncrements(
      startTimeTimeStamp,
      endTimeTimeStamp
    );
  ...
  return (
    <>
      <div className="grid-container">
        ...
        <div className="grid-header" style={{ gridColumn: "3" }}>
          End Time
        </div>
        <div className="grid-header" style={{ gridColumn: "4" }}>
          Job Cost
        </div>
